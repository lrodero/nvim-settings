...
hi CursorLineNr      guibg=#333333  guifg=yellow    gui=bold ctermbg=4 ctermfg=15
hi link CursorIM Cursor
hi Normal      guibg=#222211  guifg=white    gui=none ctermbg=0 ctermfg=15
hi NonText     guibg=#222211  guifg=#ffeecc  gui=bold ctermbg=8 ctermfg=14
hi Visual      guibg=#557799  guifg=white    gui=none ctermbg=9 ctermfg=15

hi Linenr      guibg=#333333	   guifg=#aaaaaa  gui=none ctermbg=bg ctermfg=7

hi Directory   guibg=bg	      guifg=#66ffcc  gui=none ctermbg=bg ctermfg=10
...
hi VertSplit	  guibg=#333333	 guifg=white	gui=bold ctermbg=4  ctermfg=11
...
hi String      guibg=bg	   guifg=#ffffcc  gui=none  ctermbg=bg  ctermfg=14
